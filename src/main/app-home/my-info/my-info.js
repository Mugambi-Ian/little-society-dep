...
import {validEmail, validFields, _auth, _database, _storage} from '../../../assets/config';
...
export default class MyInfo extends Component {
  ...
  async componentDidMount() {
    ...
    const user = {userName, userDp, phoneNumber, dateOfBirth, email, idNumber};
    await setTimeout(() => {
      this.setState(user);
    }, 100);
      ...
      <Animatable.View
        ...
        <Animatable.View
          ...
          <ScrollView>
            ...
            <View style={style.inputField}>
              <Text style={style.inputFieldText}>*Gender</Text>
              <View style={style.field}>
                <Image
              ...
              onPress={async () => {
                await setTimeout(async () => {
                  ...
                  if (
                    ...
                    this.props.openTimedSnack('Validate Email!');
                  } else {
